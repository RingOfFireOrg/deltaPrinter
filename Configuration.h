...
#define CUSTOM_MENDEL_NAME "Metal Delta"

// This defines the number of extruders
#define EXTRUDERS 1 //bel
...
#define DEFAULT_DELTA_DIAGONAL_ROD 289 // mm BEL

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 219 // mm // BEL

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 51 // mm BEL

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 41 // mm BEL
...
#define BED_DIAMETER 216 // mm BEL

// Z-Probe variables
// Start and end location values are used to deploy/retract the probe (will move from start to end and back again) 
#define Z_PROBE_OFFSET {0, 10, -2.2, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
...
#define X_MAX_POS 90
#define X_MIN_POS -207
#define Y_MAX_POS 90
#define Y_MIN_POS -207
#define Z_MAX_POS MANUAL_Z_HOME_POS
#define Z_MIN_POS -207
...
#define MANUAL_Z_HOME_POS 199.06  // For delta: Distance between nozzle and print surface after homing. BEL

//// MOVEMENT SETTINGS
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E
#define HOMING_FEEDRATE {200*5, 200*5, 200*5, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {110, 110, 110, 150}
...
#define REPRAP_DISCOUNT_SMART_CONTROLLER //BEL
...
//#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //BEL
