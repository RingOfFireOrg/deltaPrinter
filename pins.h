...
// #define RAMPS_V_1_0
  ...
  #define PS_ON_PIN          12
    ...
    #define HEATER_1_PIN       -1
  #else
    #define HEATER_1_PIN       10    // 9 EXTRUDER 2 (FAN On Sprinter) BEL
  #endif

  #define HEATER_2_PIN       -1 // BEL 
  ...
  #define TEMP_1_PIN         13   // 15 ANALOG NUMBERING BEL
  #define TEMP_2_PIN         -1   // ANALOG NUMBERING
    ...
    #else
      #define HEATER_BED_PIN     8    // BED BEL
    #endif
  #endif
